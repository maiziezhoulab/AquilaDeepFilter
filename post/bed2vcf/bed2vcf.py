...
python bed2vcf.py \
      ...
      --path_to_index_file /home/yunfei/workspace/AquilaDeepFilter/bed_files/HG002_60x_shortreads_raw/deletion_mapping_index.txt \
      --add_chr False
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--add_chr',
                        required=True,
                        help='index as chr1 or 1. True/chr1 of False/1')
