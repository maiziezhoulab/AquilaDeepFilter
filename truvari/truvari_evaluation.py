...
for f in vcf_files:
    ...
    if args.maximum == 0:
        ...
        out_folder_name = os.path.join(os.path.dirname(f), model_ + '_0.' + thres_ + '_' + str(args.minimum) + '_' + str(args.maximum))
    ...
    if args.maximum == 0:
        ...
        os.system('truvari bench -b ' + args.vcf_bench + ' \
                                 ...
                                 -f ' + args.fasta + ' \
                                 --includebed ' + args.include_bed + ' \
                                 --passonly -p 0.1 -P 0.1 -r 200 --sizemin ' + str(args.minimum) + ' --sizemax ' + str(args.maximum))
